...
class SyncUserRequestHandler implements RequestHandlerInterface
{
    ...
    {
        $this->logger->info('Получен новый запрос на синхронизацию менеджеров ', $request);

        return UserService::syncUsers($request);
    }
}